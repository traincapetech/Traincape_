...
const CourseCard = ({ image, title, description, price, url }) => {
  return (
    <div className="mx-auto"> 
      <Link to={url}>
      <div className="md:w-[23rem] w-fit h-[20rem] justify-between course-card flex flex-col items-center bg-white shadow-md p-4 rounded-lg text-center border border- [#212146] relative">
