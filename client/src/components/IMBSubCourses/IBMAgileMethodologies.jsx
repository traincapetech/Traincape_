   ...
   const [selectedQuestion, setSelectedQuestion] = useState(null);
     ...
     const handleAddToCart = () => {
       const product = {
         ...
         title: "IBM Web Development using Agile Methodologies Certification Course",
         price: 3000,
         image: aglie,
         quantity: 1,
       };
         ...
         <div className="h-full px-4 md:px-[6rem] lg:px-[20rem] lg:pl-[5rem] xl:px-[40rem] xl:pl-[10rem]">
           <div className="max-w-6xl mx-auto mt-6 bg-white p-6 rounded-xl shadow-lg">
             ...
             <p className="text-gray-700 mt-4 tracking-wide">
               The IBM Web Development using Agile Methodologies Certification Course provides a
               comprehensive introduction to the foundational language of the web.
               You’ll master the essentials of Agile Methodologies, learning to structure content,
             ...
             <p className="text-gray-700 mt-2 tracking-wide">
               ...
               advanced concepts like semantic Agile Methodologies5, forms, and accessibility.
               ...
               demonstrating your proficiency in Agile Methodologies and opening doors to a
             ...
             <div className="mt-4">
               ...
               {selectedQuestion === 0 && (
                 <p className="mt-2 text-gray-700">
                   ...
                   covers various topics and requires a solid understanding of Agile Methodologies
                   and its tools.{" "}
                 </p>
               )}
