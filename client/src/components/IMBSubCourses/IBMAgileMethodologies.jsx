...
const IBMAgileMethodologies = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      id: "11", // You can use a unique ID for this course
      title:
        "IBM Web Development using Agile Methodologies Certification Course",
      price: 3000,
      image: aglie,
      quantity: 1,
    };
    ...
    <>
      ...
      <div className="relative bg-gradient-to-b from-blue-100 to-white w-full h-auto md:h-[20rem] pt-10 px-4 md:px-10 text-left">
        ...
        <h1 className="text-2xl md:text-xl lg:text-4xl font-bold text-blue-900 text-center md:text-left xl:pl-20">
          IBM Web Development using Agile Methodologies <br />
      ...
      <div className="h-full px-4 md:px-[6rem] lg:px-[20rem] lg:pl-[5rem] xl:px-[40rem] xl:pl-[10rem]">
        <div className="max-w-6xl mx-auto mt-6 bg-white p-6 rounded-xl shadow-lg">
          ...
          <p className="text-gray-700 mt-4 tracking-wide">
            The IBM Web Development using Agile Methodologies Certification
            Course provides a comprehensive introduction to the foundational
            language of the web. You’ll master the essentials of Agile
            Methodologies, learning to structure content, create web pages, and
            incorporate multimedia elements.
          </p>
          <br />
          <p className="text-gray-700 mt-2 tracking-wide">
            This course covers everything from basic tags and elements to
            advanced concepts like semantic Agile Methodologies5, forms, and
            accessibility. Through hands-on projects and quizzes, you’ll gain
            practical experience in building interactive and engaging web pages.
            Upon completion, you’ll receive an industry-recognized IBM
            certification, demonstrating your proficiency in Agile Methodologies
            and opening doors to a rewarding career in web development.
          </p>
          ...
          <div className="mt-4">
            ...
            {selectedQuestion === 0 && (
              <p className="mt-2 text-gray-700">
                ...
                Agile Methodologies and its tools.{" "}
              </p>
            )}
...
export default IBMAgileMethodologies;
