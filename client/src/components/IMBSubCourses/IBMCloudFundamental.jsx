...
const IBMCloudFundamental = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      id: "13", // You can use a unique ID for this course
      title: "IBM Cloud Fundamental Certification Course",
      price: 3000,
      image: cloudfunda,
      quantity: 1,
    };
      ...
      <div className="h-full px-4 md:px-[6rem] lg:px-[20rem] lg:pl-[5rem] xl:px-[40rem] xl:pl-[10rem]">
        <div className="max-w-6xl mx-auto mt-6 bg-white p-6 rounded-xl shadow-lg">
          ...
          <p className="text-gray-700 mt-4 tracking-wide">
            This course is for Everybody who are interested to learn about Cloud
            service. This course will introduce IBM Cloud Fundamental, Paas,
            IaaS, Services, and Node-Red. <br />
            ● Learn basic information about IBM Cloud and its feature <br />●
            Learn about Pass, Iass and Node-Red{" "}
          </p>
          <br />
