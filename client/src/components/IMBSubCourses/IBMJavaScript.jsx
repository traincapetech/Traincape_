...
const IBMJavaScript = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      id: "19", // You can use a unique ID for this course
      title: "IBM IBM JavaScript Certification Course",
      price: 3000,
      image: js,
      quantity: 1,
    };
      ...
      <div className="h-full px-4 md:px-[6rem] lg:px-[20rem] lg:pl-[5rem] xl:px-[40rem] xl:pl-[10rem]">
        <div className="max-w-6xl mx-auto mt-6 bg-white p-6 rounded-xl shadow-lg">
          ...
          <p className="text-gray-700 mt-4 tracking-wide">
            The JavaScript training module provides some of the essential
            features of JavaScript. JavaScript is an important programming
            language for building the next generation of interactive web
            applications, including mobile web applications. You will learn how
            to use JavaScript to modify the Document Object Model elements of an
            HTML page.
          </p>
          <br />
          ...
          <div className="mt-4">
            ...
            {selectedQuestion === 0 && (
              <p className="mt-2 text-gray-700">
                ...
                that tests your knowledge and practical abilities in using
                JavaScript. The exam covers various topics and requires a solid
                understanding of JavaScript and its tools.{" "}
              </p>
            )}
