...
const IBMMachineLearning = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      id: "18", // You can use a unique ID for this course
      title: "IBM Machine Learning with Python Certification Course",
      price: 3000,
      image: Machine,
      quantity: 1,
    };
      ...
      <div className="h-full px-4 md:px-[6rem] lg:px-[20rem] lg:pl-[5rem] xl:px-[40rem] xl:pl-[10rem]">
        <div className="max-w-6xl mx-auto mt-6 bg-white p-6 rounded-xl shadow-lg">
          ...
          <p className="text-gray-700 mt-4 tracking-wide">
            This Machine Learning with Python course dives into the basics of
            machine learning using an approachable, and well-known, programming
            language. You’ll learn about Supervised vs Unsupervised Learning,
            look into how Statistical Modeling relates to Machine Learning, and
            do a comparison of each.
          </p>
          <br />
          ...
          <div className="mt-4">
            ...
            {selectedQuestion === 0 && (
              <p className="mt-2 text-gray-700">
                ...
                Machine Learning with Python and its tools.{" "}
              </p>
            )}
