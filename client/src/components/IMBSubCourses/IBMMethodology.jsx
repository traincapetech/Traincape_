...
const IBMMethodology = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      id: "7", // You can use a unique ID for this course
      title: "IBM Data Science Methodology Certification Course",
      price: 3000,
      image: datasci,
      quantity: 1,
    };
    ...
    <AddToCartButton />
      <div className="relative bg-gradient-to-b from-blue-100 to-white w-full h-auto md:h-[20rem] pt-10 px-4 md:px-10 text-left">
        ...
        <div className="mt-6 md:absolute md:top-10 md:right-10 w-full md:w-80 h-auto md:h-72 flex flex-col items-center md:items-start bg-white shadow-lg p-6 rounded-lg border hover:shadow-xl transition-shadow">
          ...
          {/* Image */}
          <img
            className="w-36 h-20 object-contain md:pl-20"
            src={datasci}
            alt="HTML Logo"
          />
          ...
          <h3 className="text-lg md:text-base font-bold text-blue-600 mb-4 text-center md:text-left">
            IBM Data Science Methodology Certification Course
          </h3>
      ...
      <div className="h-full px-4 md:px-[6rem] lg:px-[20rem] lg:pl-[5rem] xl:px-[40rem] xl:pl-[10rem]">
        <div className="max-w-6xl mx-auto mt-6 bg-white p-6 rounded-xl shadow-lg">
          ...
          <p className="text-gray-700 mt-4 tracking-wide">
            Despite the recent increase in computing power and access to data
            over the last couple of decades, our ability to use the data within
            the decision making process is either lost or not maximized at all
            too often, we don’t have a solid understanding of the questions
            being asked and how to apply the data correctly to the problem at
            hand.
          </p>
          <br />
          <p className="text-gray-700 mt-2 tracking-wide">
            This course has one purpose, and that is to share a methodology that
            can be used within data science, to ensure that the data used in
            problem solving is relevant and properly manipulated to address the
            question at hand.
          </p>
          ...
          <div className="mt-4">
            ...
            {selectedQuestion === 0 && (
              <p className="mt-2 text-gray-700">
                ...
                covers various topics and requires a solid understanding of Data
