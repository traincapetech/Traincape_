...
const IBMNoSQL = () => {
   const [selectedQuestion, setSelectedQuestion] = useState(null);
     ...
     const handleAddToCart = () => {
       const product = {
         id: "17", // You can use a unique ID for this course
         title: "IBM NoSQL-MongoDB Certification Course",
         price: 3000,
         image: mangodb,
         quantity: 1,
       };
            ...
            <div className="relative bg-gradient-to-b from-blue-100 to-white w-full h-auto md:h-[20rem] pt-10 px-4 md:px-10 text-left">
                ...
                <div className="mt-6 md:absolute md:top-10 md:right-10 w-full md:w-80 h-auto md:h-72 flex flex-col items-center md:items-start bg-white shadow-lg p-6 rounded-lg border hover:shadow-xl transition-shadow">
                    ...
                    <h3 className="text-lg md:text-base font-bold text-blue-600 mb-4 text-center md:text-left">
                        IBM NoSQL-MongoDB Certification Course
                    </h3>
            ...
            <div className="h-full px-4 md:px-[6rem] lg:px-[20rem] lg:pl-[5rem] xl:px-[40rem] xl:pl-[10rem]">
                <div className="max-w-6xl mx-auto mt-6 bg-white p-6 rounded-xl shadow-lg">
                    ...
                    <p className="text-gray-700 mt-4 tracking-wide">
                        This course is for Everybody who are interested in learning about NoSQL and MongoDB <br />

                        ● Learn about NoSQL and MongoDB <br />

                        ● Learn RDBMS, NoSQL, CAP Theorem, How to install MongoDB</p><br />
                    ...
                    <div className="mt-4">
                        ...
                        {selectedQuestion === 0 && (
                            <p className="mt-2 text-gray-700">
                                To earn the certification, you need to pass a comprehensive exam that tests your knowledge and practical abilities. The exam covers various topics and requires a solid understanding of NoSQL-MongoDB and its tools.{" "}
                            </p>
                        )}
