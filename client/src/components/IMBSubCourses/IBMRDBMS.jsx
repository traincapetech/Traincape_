...
const IBMRDBMS = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      id: "4", // You can use a unique ID for this course
      title: "IBM RDBMS - Database Fundamentals Certification Course",
      price: 3000,
      image: rdbms,
      quantity: 1,
    };
      ...
      <div className="h-full px-4 md:px-[6rem] lg:px-[20rem] lg:pl-[5rem] xl:px-[40rem] xl:pl-[10rem]">
        <div className="max-w-6xl mx-auto mt-6 bg-white p-6 rounded-xl shadow-lg">
          ...
          <p className="text-gray-700 mt-4 tracking-wide">
            The IBM Relational Database Management System (RDBMS) Fundamentals
            course provides a solid foundation in the core concepts and
            practices of relational databases. You’ll delve into RDBMS
            essentials like data models, normalization, and database design
            principles.
          </p>
          <br />
          <p className="text-gray-700 mt-2 tracking-wide">
            The course will equip you with the SQL language skills needed to
            effectively query, manipulate, and manage data. Through hands-on
            experience with industry-standard RDBMS tools and platforms, you’ll
            gain practical insights into how RDBMS powers businesses and
            data-driven decision-making. This course is ideal for aspiring data
            professionals, analysts, and anyone seeking to leverage the power of
            structured data.
          </p>
