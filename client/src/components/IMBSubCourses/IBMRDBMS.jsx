    ...
    return (
        <>
            <div className="relative bg-gradient-to-b from-blue-100 to-white w-full h-auto md:h-[20rem] pt-10 px-4 md:px-10 text-left">
                ...
                IBM RDBMS - Database Fundamentals <br />
                ...
                <div className="mt-6 md:absolute md:top-10 md:right-10 w-full md:w-80 h-auto md:h-72 flex flex-col items-center md:items-start bg-white shadow-lg p-6 rounded-lg border hover:shadow-xl transition-shadow">
                    ...
                    IBM RDBMS - Database Fundamentals Certification Course
                    </h3>
            ...
            <div className="h-full px-4 md:px-[6rem] lg:px-[20rem] lg:pl-[5rem] xl:px-[40rem] xl:pl-[10rem]">
                <div className="max-w-6xl mx-auto mt-6 bg-white p-6 rounded-xl shadow-lg">
                    ...
                    <p className="text-gray-700 mt-4 tracking-wide">
                        The IBM Relational Database Management System (RDBMS) Fundamentals course provides a solid foundation in the core concepts and practices of relational databases. You’ll delve into RDBMS essentials like data models, normalization, and database design principles.</p>
                    <br />
                    <p className="text-gray-700 mt-2 tracking-wide">
                    The course will equip you with the SQL language skills needed to effectively query, manipulate, and manage data. Through hands-on experience with industry-standard RDBMS tools and platforms, you’ll gain practical insights into how RDBMS powers businesses and data-driven decision-making. This course is ideal for aspiring data professionals, analysts, and anyone seeking to leverage the power of structured data.</p>
                    ...
                    <div className="mt-4">
                        ...
                        {selectedQuestion === 0 && (
                            <p className="mt-2 text-gray-700">
                                To earn the certification, you need to pass a comprehensive exam that tests your knowledge and practical abilities. The exam covers various topics and requires a solid understanding of RDBMS and its tools.{" "}
                            </p>
                        )}
