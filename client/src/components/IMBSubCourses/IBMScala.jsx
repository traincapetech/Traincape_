...
const IBMScala = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      id: "10", // You can use a unique ID for this course
      title: "IBM Scala 101 Certification Course",
      price: 3000,
      image: scala101,
      quantity: 1,
    };
      ...
      <div className="relative bg-gradient-to-b from-blue-100 to-white w-full h-auto md:h-[20rem] pt-10 px-4 md:px-10 text-left">
        ...
        <div className="mt-6 md:absolute md:top-10 md:right-10 w-full md:w-80 h-auto md:h-72 flex flex-col items-center md:items-start bg-white shadow-lg p-6 rounded-lg border hover:shadow-xl transition-shadow">
          ...
          <h3 className="text-lg md:text-base font-bold text-blue-600 mb-4 text-center md:text-left">
            IBM Scala 101 Certification Course
          </h3>
      ...
      <div className="h-full px-4 md:px-[6rem] lg:px-[20rem] lg:pl-[5rem] xl:px-[40rem] xl:pl-[10rem]">
        <div className="max-w-6xl mx-auto mt-6 bg-white p-6 rounded-xl shadow-lg">
          ...
          <p className="text-gray-700 mt-4 tracking-wide">
            Scala is a very unique programming language. It is compatible with
            Java yet a bit different, as it supports two programming paradigms:
            object-oriented programming (OOP) and functional programming (FP).
            Scala is also being used in Big data space along with Apache Spark,
            which has further fueled its adoption by many Java developers
            interested in Big Data Space. Learning Scala will certainly make you
            more marketable. Many companies are using or migrating to Scala
            these days, including Twitter, LinkedIn, Foursquare, and Quora.{" "}
          </p>
          <br />
          <p className="text-gray-700 mt-2 tracking-wide">
            The Typesafe Introductory Scala for Data Science Curriculum is
            designed to give experienced Data Developers and Data Scientists the
            knowledge to confidently start programming in Scala for data science
            tasks. The course ensures they will have a solid understanding of
            the fundamentals of the language, the tooling, and the development
            process as well as a good appreciation of the more advanced
            features. If students already have Scala programming experience,
            then this course could be a useful refresher, yet no previous
            knowledge of Scala is assumed.{" "}
          </p>
