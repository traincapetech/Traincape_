...
//         setMenuOpen(false); // Close the sidebar after clicking the link
//     };
...
//     return (
//         <nav className="bg-[#545454] lg:h-24 h-28 md:px-0 lg:px-10 pr-5 shadow-lg lg:flex">
//             <div className="mx-auto flex items-center lg:w-[15%] justify-between">
//                 {/* Logo */}
//                 <div
//                     className="flex items-center cursor-pointer"
...
//                             <div className="mt-2 bg-white text-black shadow-lg w-full">
//                                 <a
//                                     href="https://paypal.me/ParichayP?country.x=IN&locale.x=en_GB"
//                                     target="_blank"
//                                     rel="noopener noreferrer"
//                                     className="block px-4 py-2 text-sm hover:bg-blue-400 hover:text-white"
//                                     onClick={(e) => {
//                                         e.preventDefault();
//                                         handlePaymentLinkClick("https://paypal.me/ParichayP?country.x=IN&locale.x=en_GB");
//                                     }}
//                                 >
//                                     PayPal
//                                 </a>
//                                 <a
//                                     href="https://buy.stripe.com/8wM2az10TaYQgww29d"
//                                     target="_blank"
//                                     rel="noopener noreferrer"
//                                     className="block px-4 py-2 text-sm hover:bg-blue-400 hover:text-white"
//                                     onClick={(e) => {
//                                         e.preventDefault();
//                                         handlePaymentLinkClick("https://buy.stripe.com/8wM2az10TaYQgww29d");
//                                     }}
//                                 >
//                                     Credit / Debit Card
//                                 </a>
...
//                     <div className="relative" ref={dropdownRef}>
//                         <button
//                             className="text-black font-bold bg-white hover:bg-teal-100 px-4 py-2 rounded-md focus:outline-none"
//                             onClick={handlePayNow}
//                         >
//                             Pay Now
//                         </button>
