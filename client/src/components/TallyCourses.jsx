...
const TallyCourses = ({image,title, description, price,url}) => {
    useEffect(() => {
        window.scrollTo(0,0);
    ...
    return (
        <div className="flex flex-col items-center bg-white shadow-lg p-6 rounded-lg border border-[#212146] hover:shadow-xl transition-shadow">
              ...
              {/* Image */}
              <Link to={url}>
              <img className="w-20 h-20 md:w-[20rem] md:h-[13rem] mb-4 object-cover" src={image} />
              </Link>
