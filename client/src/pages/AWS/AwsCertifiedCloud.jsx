...
const AwsCertifiedCloud = () => {
    const tabs = {
        Overview: <Overview title={"Aws Certified Cloud"} />,
        Certify: <Certify title={"Aws Certified Cloud"} />,
        Learn: <Learn title={"Aws Certified Cloud"}/>,
        Practice : <Practice course={"AWS"} subTopic={"AWSCertifiedcloudpractitioner"}/>,
        'My Pathway': <MyPathway title={"Aws Certified Cloud"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
