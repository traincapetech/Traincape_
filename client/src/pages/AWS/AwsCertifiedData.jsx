...
const AwsCertifiedData = () => {
    const tabs = {
        Overview: <Overview title={"Aws Certified Data"} />,
        Certify: <Certify title={"Aws Certified Data"} />,
        Learn: <Learn title={"Aws Certified Data"}/>,
        Practice : <Practice course={"AWS"} subTopic={"AWSCertifiedDataAnalytics"}/>,
        'My Pathway': <MyPathway title={"Aws Certified Data"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
...
export default AwsCertifiedData;