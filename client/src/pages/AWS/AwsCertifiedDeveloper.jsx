...
const AwsCertifiedDeveloper = () => {
    const tabs = {
        Overview: <Overview title={"Aws Certified Developer"} />,
        Certify: <Certify title={"Aws Certified Developer"} />,
        Learn: <Learn title={"Aws Certified Developer"}/>,
        Practice : <Practice course={"AWS"} subTopic={"AWSCertifiedDeveloper"}/>,
        'My Pathway': <MyPathway title={"Aws Certified Developer"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
