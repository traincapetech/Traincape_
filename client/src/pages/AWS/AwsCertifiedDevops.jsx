...
const AwsCertifiedDevops = () => {
    const tabs = {
        Overview: <Overview title={"Aws Certified Devops"} />,
        Certify: <Certify title={"Aws Certified Devops"} />,
        Learn: <Learn title={"Aws Certified Devops"}/>,
        Practice : <Practice course={"AWS"} subTopic={"AWSCertifiedDevOps"}/>,
        'My Pathway': <MyPathway title={"Aws Certified Devops"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
...
export default AwsCertifiedDevops;