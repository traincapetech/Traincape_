...
const AwsCertifiedMachine = () => {
    const tabs = {
        Overview: <Overview title={"Aws Certified Machine"} />,
        Certify: <Certify title={"Aws Certified Machine"} />,
        Learn: <Learn title={"Aws Certified Machine"}/>,
        Practice : <Practice course={"AWS"} subTopic={"AWSCertifiedMachineLearning"}/>,
        'My Pathway': <MyPathway title={"Aws Certified Machine"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
...
export default AwsCertifiedMachine;