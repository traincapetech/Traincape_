...
const AwsCertifiedNetworking = () => {
    const tabs = {
        Overview: <Overview title={"Aws Certified Networking"} />,
        Certify: <Certify title={"Aws Certified Networking"} />,
        Learn: <Learn title={"Aws Certified Networking"}/>,
        Practice : <Practice course={"AWS"} subTopic={"AWSCertifiedAdvancedNetworking"}/>,
        'My Pathway': <MyPathway title={"Aws Certified Networking"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
