      ...
      <div className="grid sm:grid-flow-row grid-cols-1 ">
        ...
        >
          <div className="flex-grow lg:ml-4 text-center lg:text-left">
            ...
            <p className="text-gray-400 text-sm mt-2">AWS Certified Security</p>
          </div>
          ...
          <div className="flex flex-row sm:flex-row lg:flex-row gap-3 lg:w-auto justify-center">
            {Object.keys(tabs).map((key) => (
              //  <div className="flex-grow text-center" key={key}>
              <NavTab
                key={key}
                label={key}
  ...
  const CombinedOverview = () => (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
        <Overview title={"AWS Certified Security"} />
      </div>
      ...
      <div className="w-full">
        ...
        >
          ...
          <Learn title={"AWS Certified Security"} />
        </div>
        ...
        >
          ...
          <MyPathway title={"AWS Certified Security"} />
        </div>
      </div>
    </div>
  );
  ...
  const CombinedCertify = () => (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-purple-100 to-blue-50 p-6 rounded-xl border border-orange-100">
        ...
        <Certify title={"AWS Certified Security"} />
      </div>
      ...
      <div className="bg-gradient-to-r from-yellow-50 to-amber-50 p-6 rounded-xl border border-yellow-100">
        ...
        <Practice course={"AWS"} subTopic={"AWSCertifiedSecurity"} />
      </div>
    </div>
  );
