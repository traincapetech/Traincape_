...
const AwsCertifiedSecurity = () => {
    const tabs = {
        Overview: <Overview title={"Aws Certified Security"} />,
        Certify: <Certify title={"Aws Certified Security"} />,
        Learn: <Learn title={"Aws Certified Security"}/>,
        Practice : <Practice course={"AWS"} subTopic={"AWSCertifiedSecurity"}/>,
        'My Pathway': <MyPathway title={"Aws Certified Security"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
...
export default AwsCertifiedSecurity;