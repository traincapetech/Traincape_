...
const AwsCertifiedSolution = () => {
    const tabs = {
        Overview: <Overview title={"Aws Certified Solution"} />,
        Certify: <Certify title={"Aws Certified Solution"} />,
        Learn: <Learn title={"Aws Certified Solution"}/>,
        Practice : <Practice course={"AWS"} subTopic={"AWSCertifiedSolutionsArchitect"}/>,
        'My Pathway': <MyPathway title={"Aws Certified Solution"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
