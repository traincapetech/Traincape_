...
const AwsCertifiedSysops = () => {
    const tabs = {
        Overview: <Overview title={"Aws Certified Sysops"} />,
        Certify: <Certify title={"Aws Certified Sysops"} />,
        Learn: <Learn title={"Aws Certified Sysops"}/>,
        Practice : <Practice course={"AWS"} subTopic={"AWSCertifiedSysOpsAdministrator"}/>,
        'My Pathway': <MyPathway title={"Aws Certified Sysops"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
