...
const Learn = ({ title, url, image }) => {
    ...
    return (
        <>
            {/* Heading Section */}
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl text-blue-900 text-center mb-16 font-bold mt-20">
                The Pathway to {title} – Specialty Success
            </h1>


            <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-8 mt-12">
                {/* Left: Text */}
                <div className="flex-1 flex items-center">
                    <h4 className="text-base sm:text-lg md:text-xl text-gray-700 text-center md:text-left">
                        Preparing your students for the {title} – Specialty certification is an important step
                        in equipping them with the skills needed to secure cloud environments. Let Certiport
                        help streamline this process with targeted course materials and practice tests designed
                        to ensure effective learning and certification success.
                    </h4>
                </div>
            ...
            <div className="mt-20"> {/* This is the outer wrapper that adds top margin */}
            ...
            <div className="mt-16 rounded-2xl p-6 sm:p-8 md:p-10 border border-sky-200">
                <h2 className="text-xl sm:text-2xl font-bold mb-4 text-center">{`AWS Educate`}</h2>

                <h4 className="text-sm sm:text-base md:text-lg text-gray-700 text-center mb-6">
                    AWS Educate is Amazon’s global initiative to provide cloud computing resources to educators and students.
                    Through AWS Educate, your students will gain access to industry-leading curriculum and hands-on labs,
                    helping them learn the core security concepts needed for the {title} – Specialty exam.
                </h4>
