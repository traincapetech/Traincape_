...
const AdobeAfterEffects = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      id: "adobe-after-effects-certified-professional",
      title: "Adobe After Effects Certified Professional",
      price: 2499,
      image: "https://www.adobe.com/content/dam/shared/images/product-icons/svg/aftereffects.svg",
      quantity: 1,
    };
    addToCart(product);
      ...
      <div className="relative bg-gradient-to-br from-blue-50 via-cyan-50 to-white w-full h-auto md:h-[24rem] pt-10 px-4 md:px-10 text-left overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-center md:justify-start xl:pl-20">
            <img
              src="https://www.adobe.com/content/dam/shared/images/product-icons/svg/aftereffects.svg"
          ...
          <p className="text-sm md:text-base text-gray-600 mt-3 max-w-xl text-center md:text-left xl:pl-20">
            Master motion graphics and visual effects with Adobe After Effects. Become a Certified Professional in the industry's leading compositing software.
          </p>
        </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 md:bottom-10 md:left-auto md:right-10 lg:right-[1rem] lg:top-[25rem] xl:right-[15rem] xl:top-[30rem] max-w-full md:max-w-xs bg-white p-6 shadow-xl rounded-xl border border-gray-100 z-40 backdrop-blur-sm bg-white/95">
        ...
        <div className="space-y-2 mb-4">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <span>Complete After Effects mastery</span>
          </div>
          <div className="flex items-center text-sm text-gray-600">
            <FaCheck className="text-green-500 mr-2 flex-shrink-0" />
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-blue-500 to-cyan-600 text-white font-semibold py-3 px-6 rounded-lg hover:from-blue-600 hover:to-cyan-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
        >
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
              ...
              <p className="text-gray-600 mb-6">
                Adobe After Effects is the industry-standard software for motion graphics, visual effects, 
                and compositing. This comprehensive course will take you from beginner to Adobe Certified 
                Professional, covering all essential tools and techniques for creating stunning motion graphics.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <ul className="space-y-2 text-gray-600">
                    ...
                    <li>• Expressions and scripting</li>
                    <li>• 3D layers and cameras</li>
                    <li>• Rendering and optimization</li>
                  </ul>
                </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    answer: "You'll need Adobe After Effects (Creative Cloud subscription recommended for the latest features)."
                  },
                  {
                    question: "How long does the certification take?",
                    answer: "The course typically takes 8-10 weeks to complete, depending on your pace and practice time."
                  },
                  {
                    question: "Is the certification recognized?",
                    answer: "Yes, Adobe Certified Professional is globally recognized and highly valued by employers in the motion graphics industry."
                  }
                ].map((faq, index) => (
