...
const AdobeIllustrator = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      id: "adobe-illustrator-certified-professional",
      title: "Adobe Illustrator Certified Professional",
      price: 2499,
      image: "https://www.adobe.com/content/dam/shared/images/product-icons/svg/illustrator.svg",
      quantity: 1,
    };
    addToCart(product);
    ...
    <>
      ...
      <div className="relative bg-gradient-to-br from-orange-50 via-red-50 to-white w-full h-auto md:h-[24rem] pt-10 px-4 md:px-10 text-left overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-gray-800 text-center md:text-left xl:pl-20 mt-4">
            ...
            <span className="text-orange-600">Certified Professional</span>
          </h1>
          <p className="text-sm md:text-base text-gray-600 mt-3 max-w-xl text-center md:text-left xl:pl-20">
            Master vector graphics and become an Adobe Certified Professional in Illustrator for professional design work.
          </p>
        </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 md:bottom-10 md:left-auto md:right-10 lg:right-[1rem] lg:top-[25rem] xl:right-[15rem] xl:top-[30rem] max-w-full md:max-w-xs bg-white p-6 shadow-xl rounded-xl border border-gray-100 z-40 backdrop-blur-sm bg-white/95">
        <h2 className="text-lg font-bold text-gray-800 border-b pb-2 mb-3">
          Adobe Illustrator Certified Professional
        </h2>
        ...
        <div className="space-y-2 mb-4">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <span>Complete Illustrator mastery</span>
          </div>
          <div className="flex items-center text-sm text-gray-600">
            <FaCheck className="text-green-500 mr-2 flex-shrink-0" />
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-orange-500 to-red-600 text-white font-semibold py-3 px-6 rounded-lg hover:from-orange-600 hover:to-red-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
        >
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
              ...
              <p className="text-gray-600 mb-6">
                ...
                This comprehensive course will take you from beginner to Adobe Certified Professional, covering 
                all essential tools and techniques for creating stunning vector graphics.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li>• Vector drawing and illustration</li>
                    <li>• Logo and brand design</li>
                    <li>• Typography and text effects</li>
                    <li>• Color theory and gradients</li>
                    <li>• Pattern and texture creation</li>
              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    answer: "You'll need Adobe Illustrator (Creative Cloud subscription recommended for the latest features)."
                  },
                  {
                  ...
                  },
                  {
                    ...
                    answer: "Yes, Adobe Certified Professional is globally recognized and highly valued by employers."
                  }
                ].map((faq, index) => (
