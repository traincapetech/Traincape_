...
const AdobeInDesign = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      id: "adobe-indesign-certified-professional",
      title: "Adobe InDesign Certified Professional",
      price: 2499,
      image: "https://www.adobe.com/content/dam/shared/images/product-icons/svg/indesign.svg",
      quantity: 1,
    };
    addToCart(product);
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <div className="relative bg-gradient-to-br from-pink-50 via-rose-50 to-white w-full h-auto md:h-[24rem] pt-10 px-4 md:px-10 text-left overflow-hidden">
        {/* Background decorative elements */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-pink-400 opacity-5 rounded-full -mr-12 -mt-12 z-0"></div>
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-rose-400 opacity-5 rounded-full -ml-12 -mb-12 z-0"></div>
        
        <div className="relative z-10">
          <div className="flex items-center justify-center md:justify-start xl:pl-20">
            <img
              src="https://www.adobe.com/content/dam/shared/images/product-icons/svg/indesign.svg"
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-gray-800 text-center md:text-left xl:pl-20 mt-4">
            Adobe InDesign <br />
            <span className="text-pink-600">Certified Professional</span>
          </h1>
          <p className="text-sm md:text-base text-gray-600 mt-3 max-w-xl text-center md:text-left xl:pl-20">
            Master page layout and design with Adobe InDesign. Become a Certified Professional in the industry's leading desktop publishing software.
          </p>
        </div>
        ...
        <div className="mt-6 md:absolute md:top-10 md:right-10 w-full md:w-80 h-auto md:h-auto flex flex-col items-center md:items-start bg-white shadow-xl p-6 rounded-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 z-10">
          {/* Title */}
          <div className="bg-gradient-to-r from-pink-500 to-rose-600 w-full py-2 px-4 rounded-lg mb-4">
          ...
          {/* Description */}
          <h3 className="text-lg md:text-base font-bold text-pink-700 mb-4 text-center md:text-left">
            Page Layout & Design
          </h3>
      ...
      <div className="fixed bottom-0 left-0 right-0 md:bottom-10 md:left-auto md:right-10 lg:right-[1rem] lg:top-[25rem] xl:right-[15rem] xl:top-[30rem] max-w-full md:max-w-xs bg-white p-6 shadow-xl rounded-xl border border-gray-100 z-40 backdrop-blur-sm bg-white/95">
        ...
        <div className="space-y-2 mb-4">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <span>Complete InDesign mastery</span>
          </div>
          <div className="flex items-center text-sm text-gray-600">
            <FaCheck className="text-green-500 mr-2 flex-shrink-0" />
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-pink-500 to-rose-600 text-white font-semibold py-3 px-6 rounded-lg hover:from-pink-600 hover:to-rose-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
              ...
              <p className="text-gray-600 mb-6">
                Adobe InDesign is the industry-standard software for page layout and desktop publishing. 
                This comprehensive course will take you from beginner to Adobe Certified Professional, 
                covering all essential tools and techniques for creating professional publications.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li>• Page layout fundamentals</li>
                    <li>• Typography and text formatting</li>
                    <li>• Master pages and templates</li>
                    <li>• Graphics and image placement</li>
                    <li>• Color management and printing</li>
                    <li>• Digital publishing and EPUB</li>
                  </ul>
                </div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <ul className="space-y-2 text-gray-600">
                    ...
                    <li>• Magazine Designer</li>
                    <li>• Book Designer</li>
                    <li>• Marketing Designer</li>
                    <li>• Print Production Specialist</li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    answer: "You'll need Adobe InDesign (Creative Cloud subscription recommended for the latest features)."
                  },
                  {
                    question: "How long does the certification take?",
                    answer: "The course typically takes 6-8 weeks to complete, depending on your pace and practice time."
                  },
                  {
                    question: "Is the certification recognized?",
                    answer: "Yes, Adobe Certified Professional is globally recognized and highly valued by employers in the publishing industry."
                  }
                ].map((faq, index) => (
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-lg p-6 sticky top-8">
              ...
              <div className="bg-gradient-to-r from-pink-50 to-rose-50 p-4 rounded-lg mb-6">
