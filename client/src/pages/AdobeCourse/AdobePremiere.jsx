...
const AdobePremiere = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      id: "adobe-premiere-certified-professional",
      title: "Adobe Premiere Certified Professional",
      price: 2499,
      image: "https://www.adobe.com/content/dam/shared/images/product-icons/svg/premiere.svg",
      quantity: 1,
    };
    addToCart(product);
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <div className="relative bg-gradient-to-br from-purple-50 via-indigo-50 to-white w-full h-auto md:h-[24rem] pt-10 px-4 md:px-10 text-left overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-sm md:text-base text-gray-600 mt-3 max-w-xl text-center md:text-left xl:pl-20">
            Master video editing and become an Adobe Certified Professional in Premiere Pro for professional video production.
          </p>
        </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 md:bottom-10 md:left-auto md:right-10 lg:right-[1rem] lg:top-[25rem] xl:right-[15rem] xl:top-[30rem] max-w-full md:max-w-xs bg-white p-6 shadow-xl rounded-xl border border-gray-100 z-40 backdrop-blur-sm bg-white/95">
        <h2 className="text-lg font-bold text-gray-800 border-b pb-2 mb-3">
          Adobe Premiere Certified Professional
        </h2>
        ...
        <div className="space-y-2 mb-4">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <span>Complete Premiere mastery</span>
          </div>
          <div className="flex items-center text-sm text-gray-600">
            <FaCheck className="text-green-500 mr-2 flex-shrink-0" />
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-purple-500 to-indigo-600 text-white font-semibold py-3 px-6 rounded-lg hover:from-purple-600 hover:to-indigo-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
        >
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
              ...
              <p className="text-gray-600 mb-6">
                Adobe Premiere Pro is the industry-standard video editing software used by filmmakers, 
                content creators, and video professionals worldwide. This comprehensive course will take 
                you from beginner to Adobe Certified Professional, covering all essential tools and 
                techniques for professional video editing.
              </p>
              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    answer: "You'll need Adobe Premiere Pro (Creative Cloud subscription recommended for the latest features)."
                  },
                  {
                  ...
                  },
                  {
                    ...
                    answer: "Yes, Adobe Certified Professional is globally recognized and highly valued by employers in the video industry."
                  }
                ].map((faq, index) => (
