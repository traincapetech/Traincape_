...
const AdobeXD = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      id: "adobe-xd-certified-professional",
      title: "Adobe XD Certified Professional",
      price: 2499,
      image: "https://www.adobe.com/content/dam/shared/images/product-icons/svg/xd.svg",
      quantity: 1,
    };
    addToCart(product);
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <div className="relative bg-gradient-to-br from-purple-50 via-pink-50 to-white w-full h-auto md:h-[24rem] pt-10 px-4 md:px-10 text-left overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-center md:justify-start xl:pl-20">
            <img
              src="https://www.adobe.com/content/dam/shared/images/product-icons/svg/xd.svg"
              alt="Adobe XD Logo"
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-gray-800 text-center md:text-left xl:pl-20 mt-4">
            Adobe XD <br />
            <span className="text-purple-600">Certified Professional</span>
          </h1>
          <p className="text-sm md:text-base text-gray-600 mt-3 max-w-xl text-center md:text-left xl:pl-20">
            Master user experience design with Adobe XD. Become a Certified Professional in the industry's leading UX/UI design software.
          </p>
        </div>
        ...
        <div className="mt-6 md:absolute md:top-10 md:right-10 w-full md:w-80 h-auto md:h-auto flex flex-col items-center md:items-start bg-white shadow-xl p-6 rounded-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 z-10">
          {/* Title */}
          <div className="bg-gradient-to-r from-purple-500 to-pink-600 w-full py-2 px-4 rounded-lg mb-4">
      ...
      <div className="fixed bottom-0 left-0 right-0 md:bottom-10 md:left-auto md:right-10 lg:right-[1rem] lg:top-[25rem] xl:right-[15rem] xl:top-[30rem] max-w-full md:max-w-xs bg-white p-6 shadow-xl rounded-xl border border-gray-100 z-40 backdrop-blur-sm bg-white/95">
        <h2 className="text-lg font-bold text-gray-800 border-b pb-2 mb-3">
          Adobe XD Certified Professional
        </h2>
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-purple-500 to-pink-600 text-white font-semibold py-3 px-6 rounded-lg hover:from-purple-600 hover:to-pink-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
        >
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
              ...
              <p className="text-gray-600 mb-6">
                Adobe XD is the industry-standard software for user experience and user interface design. 
                This comprehensive course will take you from beginner to Adobe Certified Professional, 
                covering all essential tools and techniques for creating interactive prototypes and designs.
              </p>
              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    answer: "You'll need Adobe XD (Creative Cloud subscription recommended for the latest features)."
                  },
                  {
                  ...
                  },
                  {
                    ...
                    answer: "Yes, Adobe Certified Professional is globally recognized and highly valued by employers in the UX/UI industry."
                  }
                ].map((faq, index) => (
