...
  }, []);
    ...
    const tabs = {
        Overview: <Overview title={"Cisco Certified CyberOps Associate (CCCA)"} />,
        Certify: <Certify title={"Cisco Certified CyberOps Associate (CCCA)" } />,
        Learn: <Learn title={"Cisco Certified CyberOps Associate (CCCA) "} />,
        Practice : <Practice course={"CISCO"} subTopic={"CiscoCertifiedCyberOpsAssociate"}/>,
        'My Pathway': <MyPathway title={"Cisco Certified CyberOps Associate (CCCA)"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
