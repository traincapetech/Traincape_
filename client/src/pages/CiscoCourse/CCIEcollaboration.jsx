...
const CCIEcollaboration = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);

    const tabs = {
        Overview: <Overview title={"CCIE Collaboration"} />,
        Certify: <Certify title={"CCIE Collaboration" } />,
        Learn: <Learn title={"CCIE Collaboration "} />,
        Practice : <Practice course={"CISCO"} subTopic={"CCIECollaboration"}/>,
        'My Pathway': <MyPathway title={"CCIE Collaboration"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
...
export default CCIEcollaboration;