...
const CCIEdatacenter = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);

    const tabs = {
        Overview: <Overview title={"CCIE Data Center"} />,
        Certify: <Certify title={"CCIE Data Center" } />,
        Learn: <Learn title={"CCIE Data Center "} />,
        Practice : <Practice course={"CISCO"} subTopic={"CCIEDataCenter"}/>,
        'My Pathway': <MyPathway title={"CCIE Data Center"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
