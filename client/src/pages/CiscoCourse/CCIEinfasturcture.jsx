...
const CCIEinfasturcture = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);

    const tabs = {
        Overview: <Overview title={"CCIE Enterprise Infrastructure"} />,
        Certify: <Certify title={"CCIE Enterprise Infrastructure" } />,
        Learn: <Learn title={"CCIE Enterprise Infrastructure "} />,
        Practice : <Practice course={"CISCO"} subTopic={"CCIEEnterpriseInfrastructure"}/>,
        'My Pathway': <MyPathway title={"CCIE Enterprise Infrastructure"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
...
export default CCIEinfasturcture;