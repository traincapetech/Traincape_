...
  }, []);
    ...
    const tabs = {
        Overview: <Overview title={"CCIE Security"} />,
        Certify: <Certify title={"CCIE Security" } />,
        Learn: <Learn title={"CCIE Security "} />,
        Practice : <Practice course={"CISCO"} subTopic={"CCIESecurity"}/>,
        'My Pathway': <MyPathway title={"CCIE Security"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
