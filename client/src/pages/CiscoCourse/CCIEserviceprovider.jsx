...
const CCIEserviceprovider = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);

    const tabs = {
        Overview: <Overview title={"CCIE Service Provider"} />,
        Certify: <Certify title={"CCIE Service Provider" } />,
        Learn: <Learn title={"CCIE Service Provider "} />,
        Practice : <Practice course={"CISCO"} subTopic={"CCIEServiceProvider"}/>,
        'My Pathway': <MyPathway title={"CCIE Service Provider"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
...
export default CCIEserviceprovider;