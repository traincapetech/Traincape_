...
  }, []);
    ...
    const tabs = {
        Overview: <Overview title={"CCIE Enterprise Wireless"} />,
        Certify: <Certify title={"CCIE Enterprise Wireless" } />,
        Learn: <Learn title={"CCIE Enterprise Wireless "} />,
        Practice : <Practice course={"CISCO"} subTopic={"CCIEEnterpriseWireless"}/>,
        'My Pathway': <MyPathway title={"CCIE Enterprise Wireless"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
