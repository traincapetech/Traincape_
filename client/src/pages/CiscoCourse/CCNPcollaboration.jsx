...
const CCNPcollaboration = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);

    const tabs = {
        Overview: <Overview title={"Cisco Certified CCNP Collaboration"} />,
        Certify: <Certify title={"Cisco Certified CCNP Collaboration" } />,
        Learn: <Learn title={"Cisco Certified CCNP Collaboration "} />,
        Practice : <Practice course={"CISCO"} subTopic={"CCNPCollaboration"}/>,
        'My Pathway': <MyPathway title={"Cisco Certified CCNP Collaboration"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
...
export default CCNPcollaboration;