...
const CCNPdatacenter = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);

    const tabs = {
        Overview: <Overview title={"CCNP Data Center"} />,
        Certify: <Certify title={"CCNP Data Center" } />,
        Learn: <Learn title={"CCNP Data Center "} />,
        Practice : <Practice course={"CISCO"} subTopic={"CCNPDataCenter"}/>,
        'My Pathway': <MyPathway title={"CCNP Data Center"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
