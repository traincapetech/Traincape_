...
  }, []);
    ...
    const tabs = {
        Overview: <Overview title={"CCNP DevNet (Developer)"} />,
        Certify: <Certify title={"CCNP DevNet (Developer)" } />,
        Learn: <Learn title={"CCNP DevNet (Developer) "} />,
        Practice : <Practice course={"CISCO"} subTopic={"CCNPDevNet(Developer)"}/>,
        'My Pathway': <MyPathway title={"CCNP DevNet (Developer)"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
