...
const CCNPenterprises = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);

    const tabs = {
        Overview: <Overview title={"CCNP Enterprises"} />,
        Certify: <Certify title={"CCNP Enterprises" } />,
        Learn: <Learn title={"CCNP Enterprises "} />,
        Practice : <Practice course={"CISCO"} subTopic={"CCNPEnterprise"}/>,
        'My Pathway': <MyPathway title={"CCNP Enterprises"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
...
export default CCNPenterprises;