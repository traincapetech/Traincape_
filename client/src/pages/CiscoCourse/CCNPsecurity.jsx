...
  }, []);
    ...
    const tabs = {
        Overview: <Overview title={"CCNP Security"} />,
        Certify: <Certify title={"CCNP Security" } />,
        Learn: <Learn title={"CCNP Security "} />,
        Practice : <Practice course={"CISCO"} subTopic={"CCNPSecurity"}/>,
        'My Pathway': <MyPathway title={"CCNP Security"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
