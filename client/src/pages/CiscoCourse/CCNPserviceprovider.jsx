...
const CCNPserviceprovider = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);

    const tabs = {
        Overview: <Overview title={"CCNP Service Provider"} />,
        Certify: <Certify title={"CCNP Service Provider" } />,
        Learn: <Learn title={"CCNP Service Provider "} />,
        Practice : <Practice course={"CISCO"} subTopic={"CCNPServiceProvider"}/>,
        'My Pathway': <MyPathway title={"CCNP Service Provider"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
...
export default CCNPserviceprovider;