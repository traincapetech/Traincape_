...
  }, []);
    ...
    const tabs = {
        Overview: <Overview title={"CCST Cybersecurity"} />,
        Certify: <Certify title={"CCST Cybersecurity" } />,
        Learn: <Learn title={"CCST Cybersecurity "} />,
        Practice : <Practice course={"CISCO"} subTopic={"CCSTCybersecurity"}/>,
        'My Pathway': <MyPathway title={"CCST Cybersecurity"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
