...
import { FaShieldAlt, FaClock, FaCheckCircle, FaHeadset, FaLock, FaCertificate, FaStar, FaNetworkWired } from 'react-icons/fa';

const CCSTNetworking = () => {
      ...
      <div className="bg-white shadow-lg border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">›</span>
            <span className="text-blue-600 font-semibold">CCST Networking</span>
          </div>
        </div>
      </div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 px-4 md:px-10 py-12">
          <div className="max-w-7xl mx-auto grid md:grid-cols-[1fr_320px] gap-8 items-start">
            <div>
              <h1 className="text-3xl md:text-4xl font-extrabold text-white tracking-tight">Cisco CCST Networking Voucher</h1>
              <p className="text-blue-100 mt-3 max-w-2xl">Get an official exam voucher for CCST Networking. Add to cart and checkout securely. Voucher is delivered instantly to your email.</p>
            ...
            <div className="md:sticky md:top-24">
              <div className="bg-white/90 backdrop-blur shadow-2xl p-6 rounded-2xl border border-white/60">
                ...
                <p className="text-sm text-gray-600 mb-4 text-center">CCST Networking Exam</p>
                <VoucherButton course={"Cisco"} subCourse={"CCSTNetworking"} className="w-full justify-center" />
      ...
      <div className="h-full px-4 md:px-[6rem] lg:px-[12rem] xl:px-[18rem]">
        <div className="max-w-6xl mx-auto mt-8 space-y-10">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
            <h3 className="text-xl font-bold text-gray-900 mb-2 flex items-center gap-2"><FaNetworkWired className="text-blue-600" /> Description</h3>
            <p className="text-gray-700 mt-1 tracking-wide">
              CCST Networking validates foundational knowledge of networking concepts,
              devices, connectivity and troubleshooting to prepare you for entry‑level
              roles. The exam content is aligned with real workplace expectations.
            </p>
            <p className="text-gray-700 mt-2 tracking-wide">
              Use your voucher to schedule the exam online. After purchase, the code is
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="p-4 rounded-lg border bg-blue-50/50">
                ...
                <p className="text-gray-700 mt-2 text-sm">Demonstrates readiness for real networking roles and responsibilities.</p>
              </div>
              <div className="p-4 rounded-lg border bg-green-50/50">
                ...
                <p className="text-gray-700 mt-2 text-sm">Hands‑on objectives mapped to industry expectations.</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="p-4 rounded-lg border text-center">
                ...
                <div className="font-semibold text-gray-900">Online (Certiport)</div>
              </div>
              <div className="p-4 rounded-lg border text-center">
                <div className="text-sm text-gray-500">Duration</div>
                <div className="font-semibold text-gray-900">~50–60 min</div>
              </div>
              <div className="p-4 rounded-lg border text-center">
              ...
              <div className="p-4 rounded-lg border text-center">
                ...
                <div className="font-semibold text-gray-900">Instant email</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
            ...
            <ul className="space-y-2">
              {[
                "Official CCST Networking exam voucher",
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
            ...
            <div className="space-y-3">
              <details className="group border rounded-md p-3">
                <summary className="cursor-pointer font-semibold text-gray-900">How do I receive my voucher?</summary>
                <p className="mt-2 text-gray-700">Immediately by email after successful payment.</p>
              </details>
              <details className="group border rounded-md p-3">
                <summary className="cursor-pointer font-semibold text-gray-900">Is the voucher refundable?</summary>
                <p className="mt-2 text-gray-700">Vouchers are generally non‑refundable once issued.</p>
              </details>
              <details className="group border rounded-md p-3">
                <summary className="cursor-pointer font-semibold text-gray-900">Need help?</summary>
                <p className="mt-2 text-gray-700">Contact us via the Contact page; we typically respond within 24 hours.</p>
              </details>
            </div>
          </div>
        </div>
