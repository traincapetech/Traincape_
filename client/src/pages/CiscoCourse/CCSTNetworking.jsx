...
  }, []);
    ...
    const tabs = {
        Overview: <Overview title={"CCST Networking"} />,
        Certify: <Certify title={"CCST Networking" } />,
        Learn: <Learn title={"CCST Networking "} />,
        Practice : <Practice course={"CISCO"} subTopic={"CCSTNetworking"}/>,
        'My Pathway': <MyPathway title={"CCST Networking"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
