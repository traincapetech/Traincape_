...
  }, []);
    ...
    const tabs = {
        Overview: <Overview title={"CCT Data Center (Exam: 010-151 DCTECH)"} />,
        Certify: <Certify title={"CCT Data Center (Exam: 010-151 DCTECH)" } />,
        Learn: <Learn title={"CCT Data Center (Exam: 010-151 DCTECH) "} />,
        Practice : <Practice course={"CISCO"} subTopic={"CCTDataCenter(Exam: 010-151 DCTECH)"}/>,
        'My Pathway': <MyPathway title={"CCT Data Center (Exam: 010-151 DCTECH)"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
