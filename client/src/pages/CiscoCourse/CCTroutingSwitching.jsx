...
const CCTroutingSwitching = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);

    const tabs = {
        Overview: <Overview title={"CCT Routing & Switching (Exam: 100-490 RSTECH)"} />,
        Certify: <Certify title={"CCT Routing & Switching (Exam: 100-490 RSTECH)" } />,
        Learn: <Learn title={"CCT Routing & Switching (Exam: 100-490 RSTECH) "} />,
        Practice : <Practice course={"CISCO"} subTopic={"CCTRouting&Switching(Exam: 100-490 RSTECH)"}/>,
        'My Pathway': <MyPathway title={"CCT Routing & Switching (Exam: 100-490 RSTECH)"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
...
export default CCTroutingSwitching;