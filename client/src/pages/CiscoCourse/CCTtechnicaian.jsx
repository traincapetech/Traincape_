...
const CCTtechnicaian = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);

    const tabs = {
        Overview: <Overview title={"Cisco Certified Technician (CCT)"} />,
        Certify: <Certify title={"Cisco Certified Technician (CCT)" } />,
        Learn: <Learn title={"Cisco Certified Technician (CCT) "} />,
        Practice : <Practice course={"CISCO"} subTopic={"CiscoCertifiedTechnician(CCT)"}/>,
        'My Pathway': <MyPathway title={"Cisco Certified Technician (CCT)"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
