...
import LearnImg from '../../assets/Cisco/Learnimg.jpg';


const CiscoLearn = ({ title, title2, image }) => {
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="bg-sky-100 rounded-2xl py-4 px-6 sm:px-8 md:px-12 mb-8">
        ...
        Cisco has partnered with leading curriculum providers to offer high-quality learning materials tailored to the {title2} certification. These resources cover all exam objectives and provide students with the knowledge and skills needed to succeed in cybersecurity roles. <br />
        We currently offer learning materials through trusted partners such as CertMaster Learn and CertMaster Labs, with additional options available from renowned curriculum providers. Stay tuned for new learning products or connect directly with your Cisco representative to explore the latest offerings.
        </h4>
      </div>
