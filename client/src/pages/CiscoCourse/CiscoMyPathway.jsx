...
import pathway from '../../assets/Cisco/Mypathway.webp';

const CiscoMyPathway = ({ title, url, image }) => {
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div 
        className="relative h-[43vh] sm:h-[30vh]   lg:h-[60vh]"
