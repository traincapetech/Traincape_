          ...
          <NavTab
            ...
            icon={
              key === 'Overview'
                ...
                : <GiPathDistance className='w-10 h-10' />
            }
          />
        ))}
      </nav>
...
const ComptiaA = () => {
    const tabs = {
        Overview: <Overview title={"Cybersecurity with CompTIA A+"} />,
        Certify: <Certify title={"Certify with CompTIA A+" }title2={"CompTIA A+"} />,
        Learn: <Learn title={"CompTIA A+"} title2={"A+"}/>,
        Practice: <Practice course={"comptia"} subTopic={"CompTIAA+"} />,
        'My Pathway': <MyPathway title={"CompTIA A+"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
