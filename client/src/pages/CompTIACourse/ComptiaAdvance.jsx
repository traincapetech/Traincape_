...
const ComptiaAdavnce = () => {
    const tabs = {
        Overview: <Overview title={"cybersecurity with CompTIA Advance"} />,
        Certify: <Certify title={"Certify with CompTIA PenTest" }title2={"CompTIA Advance"} />,
        Learn: <Learn title={"CompTIA Advance"} title2={"Advance"}/>,
        Practice: <Practice course={"comptia"} subTopic={"CompTIAAdvancedSecurity"}/>,
        'My Pathway': <MyPathway title={"CompTIA Advance"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
