...
const ComptiaCloud = () => {
    const tabs = {
        Overview: <Overview title={"cybersecurity with CompTIA Cloud"} />,
        Certify: <Certify title={"Certify with CompTIA Cloud" }title2={"CompTIA Cloud"} />,
        Learn: <Learn title={"CompTIA Cloud"} title2={"Cloud"}/>,
        Practice : <Practice course={"comptia"} subTopic={"CompTIACloud+"}/>,
