...
const NavTab = ({ label, active, onClick, icon }) => {
    return (
      <button
        onClick={onClick}
        className={`text-lg flex gap-4 items-center hover:bg-gray-700 px-4 py-2 rounded transition ${active ? 'bg-gray-700' : ''} md:text-base lg:text-lg`}
      >
...
const ComptiaCloudCLO = () => {
    const tabs = {
        Overview: <Overview title={"cybersecurity with CompTIA Cloud CLO"} />,
        Certify: <Certify title={"Certify with CompTIA Cloud CLO" }title2={"CompTIA Cloud "} />,
        Learn: <Learn title={"CompTIA Cloud CLO"} title2={"Cloud "}/>,
        Practice : <Practice course={"comptia"} subTopic={"CompTIACloudEssentials+"}/>,
        'My Pathway': <MyPathway title={"CompTIA Cloud"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
...
export default ComptiaCloudCLO;