...
const NavTab = ({ label, active, onClick, icon }) => {
    return (
      <button
        onClick={onClick}
        className={`text-lg flex gap-4 w-full items-center hover:bg-gray-700 px-4 py-2 rounded transition ${active ? 'bg-gray-700' : ''} md:text-base lg:text-lg`}
      >
...
const ComptiaCybersecurity = () => {
    const tabs = {
        Overview: <Overview title={"cybersecurity with CompTIA Cyber Security"} />,
        Certify: <Certify title={"Certify with CompTIA Cyber Security " }title2={"CompTIA Cyber Security"} />,
        Learn: <Learn title={"CompTIA Cyber Security"} title2={" Cyber Security"}/>,
        Practice : <Practice course={"comptia"} subTopic={"CompTIACybersecurityAnalyst"}/>,
        'My Pathway': <MyPathway title={"CompTIA Cyber Security"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
...
export default ComptiaCybersecurity;