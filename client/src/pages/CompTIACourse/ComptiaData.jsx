...
const ComptiaData = () => {
    const tabs = {
        Overview: <Overview title={"cybersecurity with CompTIA Data"} />,
        Certify: <Certify title={"Certify with CompTIA Data" }title2={"CompTIA Data"} />,
        Learn: <Learn title={"CompTIA Data"} title2={"Data"}/>,
        Practice : <Practice course={"comptia"} subTopic={"CompTIAData+"}/>,
        'My Pathway': <MyPathway title={"CompTIA Data"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
