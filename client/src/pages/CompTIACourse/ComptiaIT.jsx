...
const ComptiaIT = () => {
    const tabs = {
        Overview: <Overview title={"cybersecurity with CompTIA IT"} />,
        Certify: <Certify title={"Certify with CompTIA IT" }title2={"CompTIA IT"} />,
        Learn: <Learn title={"CompTIA IT"} title2={"IT"}/>,
        Practice : <Practice />,
        'My Pathway': <MyPathway title={"CompTIA IT"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
