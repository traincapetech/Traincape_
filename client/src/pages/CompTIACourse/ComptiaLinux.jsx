...
const ComptiaLinux = () => {
    const tabs = {
        Overview: <Overview title={"CompTIA Linux certification "} />,
        Certify: <Certify title={"CompTIA Linux " }title2={"CompTIA Linux"} />,
        Learn: <Learn title={"CompTIA Linux"} title2={"Linux"}/>,
        Practice : <Practice course={"comptia"} subTopic={"CompTIALinux+"}/>,
        'My Pathway': <MyPathway title={"CompTIA Linux"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
