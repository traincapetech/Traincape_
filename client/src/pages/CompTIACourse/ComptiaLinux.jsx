      ...
      <div className="grid sm:grid-flow-row grid-cols-1 lg:flex">
        ...
        >
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-center text-sm mt-2">CompTIA Linux+ Certification</p>
          </div>
  ...
  const CombinedCertify = () => (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-yellow-50 to-amber-50 p-6 rounded-xl border border-yellow-100">
        ...
        <Practice course={"CompTIA"} subTopic={"CompTIALinux"}/>
      </div>
    </div>
  );
      ...
      <div className="bg-white shadow-lg border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">›</span>
            <span className="text-blue-600 font-semibold">Linux+</span>
          </div>
        </div>
      </div>
