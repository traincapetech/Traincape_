...
const ComptiaNetwork = () => {
    const tabs = {
        Overview: <Overview title={"Cybersecurity with CompTIA Network"} />,
        Certify: <Certify title={"Certify with CompTIA Network" }title2={"CompTIA Network"} />,
        Learn: <Learn title={"CompTIA Network"} title2={"Network"}/>,
        Practice : <Practice course={"comptia"} subTopic={"CompTIANetwork+N10-008"}/>,
