...
// import ComptiaNetwork from './ComptiaNetwork';
...
const ComptiaNetwork007 = () => {
    const tabs = {
        Overview: <Overview title={"cybersecurity with CompTIA Network 007"} />,
        Certify: <Certify title={"Certify with CompTIA Network 007" }title2={"CompTIA Network "} />,
        Learn: <Learn title={"CompTIA Network"} title2={"Network"}/>,
        Practice : <Practice course={"comptia"} subTopic={"CompTIANetwork+N10-007"}/>,
        'My Pathway': <MyPathway title={"CompTIA Network"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
...
export default ComptiaNetwork007;