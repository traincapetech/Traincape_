...
const ComptiaProject = () => {
    const tabs = {
        Overview: <Overview title={"cybersecurity with CompTIA Project+ PK0-005"} />,
        Certify: <Certify title={"Certify with CompTIA Project+ PK0-005" }title2={"CompTIA Project+"} />,
        Learn: <Learn title={"CompTIA Project+"} title2={"Project+"}/>,
        Practice : <Practice course={"comptia"} subTopic={"CompTIAProject+005"}/>,
        'My Pathway': <MyPathway title={"CompTIA Project+"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
