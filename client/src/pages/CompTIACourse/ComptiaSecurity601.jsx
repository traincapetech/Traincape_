...
const ComptiaSecurity601 = () => {
    const tabs = {
        Overview: <Overview title={"cybersecurity with CompTIA Security SY0-701"} />,
        Certify: <Certify title={"Certify with CompTIA Security SY0-701" }title2={"CompTIA Security"} />,
        Learn: <Learn title={"CompTIA Security"} title2={"Security"}/>,
        Practice : <Practice course={"comptia"} subTopic={"CompTIASecurity+601"}/>,
        'My Pathway': <MyPathway title={"CompTIA Security"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
