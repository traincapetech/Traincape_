...
const ComptiaServer = () => {
    const tabs = {
        Overview: <Overview title={"cybersecurity with CompTIA Server"} />,
        Certify: <Certify title={"Certify with CompTIA Server" }title2={"CompTIA Server"} />,
        Learn: <Learn title={"CompTIA Server"} title2={"Server"}/>,
        Practice : <Practice course={"comptia"} subTopic={"CompTIAServer+"}/>,
        'My Pathway': <MyPathway title={"CompTIA Server"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
