...
import LearnImg from '../../assets/comptialearn.jpeg';
...
const Learn = ({ title, title2, image }) => {
  ...
  return (
    <>
      ...
      {/* Image Section */}
      <div className="w-full max-w-full mx-auto justify-center flex mb-8">
        <img className="w-full lg:w-[80%] h-auto" src={LearnImg} alt={`${title}Learning`} />
      </div>
      ...
      <div className="bg-sky-100 rounded-2xl py-4 px-6 sm:px-8 md:px-12 mb-8">
        ...
        CompTIA has partnered with leading curriculum providers to offer high-quality learning materials tailored to the {title2} certification. These resources cover all exam objectives and provide students with the knowledge and skills needed to succeed in cybersecurity roles. <br />
        We currently offer learning materials through trusted partners such as CertMaster Learn and CertMaster Labs, with additional options available from renowned curriculum providers. Stay tuned for new learning products or connect directly with your CompTIA representative to explore the latest offerings.
        </h4>
      </div>
      ...
      Equip your students for a successful cybersecurity career with CompTIA Security+ and industry-aligned resources designed for their success!
      </h4>
