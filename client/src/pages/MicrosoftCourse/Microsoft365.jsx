...
const Microsoft365 = () => {
  useEffect(() => {
    ...
    const tabs = {
        Overview: <MicrosoftOverview title={"Microsoft 365"} />,
        Certify: <Certify title={"Microsoft 365" } />,
        Learn: <Learn title={"Microsoft 365 "} />,
        Practice : <Practice course={"Microsoft"} subTopic={"Microsoft365"}/>,
        'My Pathway': <MyPathway title={"Microsoft 365"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
