...
const Microsoft365Associate = () => {
    const tabs = {
        Overview: <MicrosoftOverview title={"Microsoft 365 certified teams administrator associate"} />,
        Certify: <Certify title={"Microsoft 365 certified teams administrator associate" } />,
        Learn: <Learn title={"Microsoft 365 certified teams administrator associate "} />,
        Practice : <Practice course={"Microsoft"} subTopic={"Microsoft365Associate"}/>,
        'My Pathway': <MyPathway title={"Microsoft 365 certified teams administrator associate"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
