  ...
  const CombinedOverview = () => (
    <div className="space-y-8">
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
        <MicrosoftOverview title="Microsoft 365 certifications" />
      </div>
      ...
      >
        ...
        <Learn title="Microsoft 365 certifications" />
      </div>
      ...
      >
        ...
        <MyPathway title="Microsoft 365 certifications" />
      </div>
    </div>
  );
  ...
  const CombinedCertify = () => (
    <div className="space-y-8">
      <div className="bg-gradient-to-r from-purple-100 to-blue-50 p-6 rounded-xl border border-orange-100">
        ...
        <Certify title="Microsoft 365 certifications" />
      </div>
      ...
      <div className="bg-white shadow-md border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">›</span>
            <span className="text-blue-600 font-semibold">Microsoft 365 Certifications</span>
          </div>
        </div>
      </div>
