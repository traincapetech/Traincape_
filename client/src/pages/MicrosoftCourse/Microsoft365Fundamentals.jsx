...
const Microsoft365Fundamentals = () => {
    const tabs = {
        Overview: <MicrosoftOverview title={"Microsoft 365 Fundamentals"} />,
        Certify: <Certify title={"Microsoft 365 Fundamentals" } />,
        Learn: <Learn title={"Microsoft 365 Fundamentals "} />,
        Practice : <Practice course={"Microsoft"} subTopic={"Microsoft365Fundamentals"}/>,
        'My Pathway': <MyPathway title={"Microsoft 365 Fundamentals"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
