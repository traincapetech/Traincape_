...
const MicrosoftAi = () => {
    const tabs = {
        Overview: <MicrosoftOverview title={"Microsoft Azure AI Fundamentals"} />,
        Certify: <Certify title={"Microsoft Azure AI Fundamentals" } />,
        Learn: <Learn title={"Microsoft Azure AI Fundamentals "} />,
        Practice : <Practice course={"Microsoft"} subTopic={"MicrosoftAzureAIFundamentals"}/>,
        'My Pathway': <MyPathway title={"Microsoft Azure AI Fundamentals"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
