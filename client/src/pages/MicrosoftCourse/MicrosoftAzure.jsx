...
const MicrosoftAzure = () => {
    const tabs = {
        Overview: <MicrosoftOverview title={"Microsoft Azure"} />,
        Certify: <Certify title={"Microsoft Azure" } />,
        Learn: <Learn title={"Microsoft Azure "} />,
        Practice : <Practice course={"Microsoft"} subTopic={"MicrosoftAzure"}/>,
        'My Pathway': <MyPathway title={"Microsoft Azure"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
