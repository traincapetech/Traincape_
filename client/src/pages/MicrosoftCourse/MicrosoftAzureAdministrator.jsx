...
const MicrosoftAzureAdministrator = () => {
    const tabs = {
        Overview: <MicrosoftOverview title={"Microsoft Azure Administrator Certificate"} />,
        Certify: <Certify title={"Microsoft Azure Administrator Certificate" } />,
        Learn: <Learn title={"Microsoft Azure Administrator Certificate"} />,
        Practice : <Practice course={"Microsoft"} subTopic={"MicrosoftAzureAdministrator"}/>,
        'My Pathway': <MyPathway title={"Microsoft Azure Administrator"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
