  ...
  const CombinedOverview = () => (
    <div className="space-y-8">
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
        <MicrosoftOverview title="Microsoft Azure Cosmos DB Developer Specialty" />
      </div>
      ...
      <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-xl border border-green-100">
        ...
        <Learn title="Microsoft Azure Cosmos DB Developer Specialty" />
      </div>
      ...
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-xl border border-purple-100">
        ...
        <MyPathway title="Microsoft Azure Cosmos DB Developer Specialty" />
      </div>
    </div>
  );
  ...
  const CombinedCertify = () => (
    <div className="space-y-8">
      <div className="bg-gradient-to-r from-orange-50 to-red-50 p-6 rounded-xl border border-orange-100">
        ...
        <Certify title="Microsoft Azure Cosmos DB Developer Specialty" />
      </div>
      ...
      <div className="bg-gradient-to-r from-yellow-50 to-amber-50 p-6 rounded-xl border border-yellow-100">
        ...
        <Practice course="Microsoft" subTopic="AzureCosmos" />
      </div>
    </div>
  );
  ...
  return (
    <>
      ...
      <div className="bg-white shadow-md border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">›</span>
            <span className="text-blue-600 font-semibold">Microsoft Azure Cosmos DB Developer</span>
          </div>
        </div>
      </div>
      ...
      <TabContainer
        ...
        subtitle="Microsoft Azure Cosmos DB Developer Specialty"
      />
    </>
  );
};

export default MicrosoftAzureCosmos;
