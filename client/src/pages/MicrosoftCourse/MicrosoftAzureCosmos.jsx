...
const MicrosoftAzureCosmos = () => {
    const tabs = {
        Overview: <MicrosoftOverview title={"Microsoft Azure Cosmos DB Developer Specialty"} />,
        Certify: <Certify title={"Microsoft Azure Cosmos DB Developer Specialty" } />,
        Learn: <Learn title={"Microsoft Azure Cosmos DB Developer Specialty "} />,
        Practice : <Practice course={"Microsoft"} subTopic={"MicrosoftAzureCosmosDBDeveloperSpecialty"}/>,
        'My Pathway': <MyPathway title={"Microsoft Azure Cosmos DB Developer Specialty"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
