...
const MicrosoftAzureData = () => {
    const tabs = {
        Overview: <MicrosoftOverview title={"Microsoft Azure Data Fundamentals"} />,
        Certify: <Certify title={"Microsoft Azure Data Fundamentals" } />,
        Learn: <Learn title={"Microsoft Azure Data Fundamentals "} />,
        Practice : <Practice course={"Microsoft"} subTopic={"MicrosoftAzureDataFundamentals"}/>,
        'My Pathway': <MyPathway title={"Microsoft Azure Data Fundamentals"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
