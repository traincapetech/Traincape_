...
const MicrosoftAzureSAP = () => {
    const tabs = {
        Overview: <MicrosoftOverview title={"Microsoft Azure for SAP workloads Specialty"} />,
        Certify: <Certify title={"Microsoft Azure for SAP workloads Specialty" } />,
        Learn: <Learn title={"Microsoft Azure for SAP workloads Specialty "} />,
        Practice : <Practice course={"Microsoft"} subTopic={"MicrosoftAzureforSAPworkloadsSpecialty"}/>,
        'My Pathway': <MyPathway title={"Microsoft Azure for SAP workloads Specialty"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
