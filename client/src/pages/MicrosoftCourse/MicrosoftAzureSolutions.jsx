...
const MicrosoftAzureSolutions = () => {
    const tabs = {
        Overview: <MicrosoftOverview title={"Microsoft Azure Solutions Architect Expert"} />,
        Certify: <Certify title={"Microsoft Azure Solutions Architect Expert" } />,
        Learn: <Learn title={"Microsoft Azure Solutions Architect Expert "} />,
        Practice : <Practice course={"Microsoft"} subTopic={"MicrosoftAzureSolutionsArchitectExpert"}/>,
        'My Pathway': <MyPathway title={"Microsoft Azure Solutions Architect Expert"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
