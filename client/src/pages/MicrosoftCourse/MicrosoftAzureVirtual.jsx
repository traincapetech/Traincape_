...
const MicrosoftAzureVirtual = () => {
    const tabs = {
        Overview: <MicrosoftOverview title={"Microsoft Azure Virtual Desktop Specialty"} />,
        Certify: <Certify title={"Microsoft Azure Virtual Desktop Specialty" } />,
        Learn: <Learn title={"Microsoft Azure Virtual Desktop Specialty "} />,
        Practice : <Practice course={"Microsoft"} subTopic={"MicrosoftAzureVirtualDesktopSpecialty"}/>,
        'My Pathway': <MyPathway title={"Microsoft Azure Virtual Desktop Specialty"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
