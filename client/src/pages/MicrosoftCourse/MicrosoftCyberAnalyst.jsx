...
const MicrosoftCyberAnalyst = () => {
    const tabs = {
        Overview: <MicrosoftOverview title={"Microsoft Cybersecurity Analyst"} />,
        Certify: <Certify title={"Microsoft Cybersecurity Analyst" } />,
        Learn: <Learn title={"Microsoft Cybersecurity Analyst "} />,
        Practice : <Practice course={"Microsoft"} subTopic={"MicrosoftCybersecurityAnalyst"}/>,
        'My Pathway': <MyPathway title={"Microsoft Cybersecurity Analyst"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
