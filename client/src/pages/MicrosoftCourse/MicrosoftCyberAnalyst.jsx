...
const NavTab = ({ label, active, onClick, icon }) => {
  ...
  return (
    <button
      onClick={onClick}
      className={`text-lg flex gap-3 items-center px-6 py-3 rounded-xl transition 
      ${active ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-md' : 'text-gray-300 hover:text-white hover:bg-gray-700'}`}
    >
  ...
  const CombinedOverview = () => (
    <div className="space-y-8">
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
        <MicrosoftOverview title="Microsoft Cybersecurity Analyst" />
      </div>
      ...
      <div id="learning" className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-xl border border-green-100 scroll-mt-24">
        <h3 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
          <FaBook className="mr-3 text-green-600" /> Learning Resources
        </h3>
        <Learn title="Microsoft Cybersecurity Analyst" />
      </div>

      <div id="pathway" className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-xl border border-purple-100 mt-16 scroll-mt-24">
        <h3 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
          <GiPathDistance className="mr-3 text-purple-600" /> Career Pathway
        </h3>
        <MyPathway title="Microsoft Cybersecurity Analyst" />
      </div>
    </div>
  );
    ...
    <div className="space-y-8">
      <div className="bg-gradient-to-r from-purple-100 to-blue-50 p-6 rounded-xl border border-orange-100">
        <h3 className="text-2xl font-bold text-gray-800 mb-10 flex items-center">
          <FaCertificate className="mr-3 text-orange-600" /> Certification Details
        </h3>
        <Certify title="Microsoft Cybersecurity Analyst" />
      </div>

      <div className="bg-gradient-to-r from-yellow-50 to-amber-50 p-6 rounded-xl border border-yellow-100">
        <h3 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
          <BsFillPenFill className="mr-3 text-yellow-600" /> Practice & Assessment
        </h3>
        <Practice course="Microsoft" subTopic="MicrosoftCybersecurityAnalyst" />
      </div>
    </div>
  );
...
export default MicrosoftCyberAnalyst;
