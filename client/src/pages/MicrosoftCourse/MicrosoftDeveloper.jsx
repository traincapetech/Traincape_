...
const MicrosoftDeveloper = () => {
    const tabs = {
        Overview: <MicrosoftOverview title={"Microsoft Azure Developer Associate"} />,
        Certify: <Certify title={"Microsoft Azure Developer Associate" } />,
        Learn: <Learn title={"Microsoft Azure Developer Associate "} />,
        Practice : <Practice course={"Microsoft"} subTopic={"MicrosoftAzureDeveloperAssociate"}/>,
        'My Pathway': <MyPathway title={"Microsoft Azure Developer Associate"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
