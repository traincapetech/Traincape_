  ...
  const CombinedOverview = () => (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
        <MicrosoftOverview title="Microsoft Azure Developer Associate" />
      </div>
      ...
      <div className="w-full">
        ...
        >
          ...
          <Learn title="Microsoft Azure Developer Associate" />
        </div>
        ...
        >
          ...
          <MyPathway title="Microsoft Azure Developer Associate" />
        </div>
      </div>
    </div>
  );
  ...
  const CombinedCertify = () => (
    <div className="space-y-8">
      <div className="bg-gradient-to-r from-purple-100 to-blue-50 p-6 rounded-xl border border-orange-100">
        ...
        <Certify title="Microsoft Azure Developer Associate" />
      </div>
      ...
      <div className="bg-gradient-to-r from-yellow-50 to-amber-50 p-6 rounded-xl border border-yellow-100">
        ...
        <Practice course="Microsoft" subTopic="AzureDeveloper" />
      </div>
    </div>
  );
    ...
    <div className="bg-white shadow-md border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center space-x-2 text-sm">
          ...
          <span className="text-gray-400">›</span>
          <span className="text-blue-600 font-semibold">Azure Developer</span>
        </div>
      </div>
    </div>
     {/* Breadcrumb */}
      ...
      subtitle="Microsoft Azure Developer Associate"
    />
    </>
  );
};

export default MicrosoftDeveloper;
