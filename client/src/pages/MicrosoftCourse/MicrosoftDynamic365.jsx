...
const MicrosoftDynamic365 = () => {
    const tabs = {
        Overview: <MicrosoftOverview title={"Microsoft Dynamic 365"} />,
        Certify: <Certify title={"Microsoft Dynamic 365" } />,
        Learn: <Learn title={"Microsoft Dynamic 365 "} />,
        Practice : <Practice course={"Microsoft"} subTopic={"MicrosoftDynamics365"}/>,
        'My Pathway': <MyPathway title={"Microsoft Dynamic 365"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
