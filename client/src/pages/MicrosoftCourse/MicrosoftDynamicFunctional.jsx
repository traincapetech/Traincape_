...
const  MicrosoftDynamicFunctional = () => {
    const tabs = {
        Overview: <MicrosoftOverview title={"Microsoft Dynamics 365 Sales Functional Consultant Associate"} />,
        Certify: <Certify title={"Microsoft Dynamics 365 Sales Functional Consultant Associate" } />,
        Learn: <Learn title={"Microsoft Dynamics 365 Sales Functional Consultant Associate "} />,
        Practice : <Practice course={"Microsoft"} subTopic={"MicrosoftDynamics365SalesFunctionalConsultantAssociate"}/>,
        'My Pathway': <MyPathway title={"Microsoft Dynamics 365 Sales Functional Consultant Associate"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
