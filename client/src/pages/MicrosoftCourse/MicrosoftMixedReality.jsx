      ...
      <div className="grid sm:grid-flow-row grid-cols-1 lg:flex">
        ...
        >
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-center text-sm mt-2">Microsoft Mixed Reality Certification</p>
          </div>
  ...
  const CombinedOverview = () => (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
        <Overview title={"Microsoft Mixed Reality"} />
      </div>
      ...
      <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-xl border border-green-100">
        ...
        <Learn title={"Microsoft Mixed Reality"} />
      </div>
      ...
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-xl border border-purple-100">
        ...
        <MyPathway title={"Microsoft Mixed Reality"} />
      </div>
    </div>
  );
  ...
  const CombinedCertify = () => (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-orange-50 to-red-50 p-6 rounded-xl border border-orange-100">
        ...
        <Certify title={"Microsoft Mixed Reality"} />
      </div>
      ...
      <div className="bg-gradient-to-r from-yellow-50 to-amber-50 p-6 rounded-xl border border-yellow-100">
        ...
        <Practice course={"Microsoft"} subTopic={"MicrosoftMixedReality"}/>
      </div>
    </div>
  );
      ...
      <div className="bg-white shadow-lg border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">›</span>
            <span className="text-blue-600 font-semibold">Mixed Reality</span>
          </div>
        </div>
      </div>
...
export default MicrosoftMixedReality;
