...
// TabContainer with horizontal tabs
  ...
  const CombinedOverview = () => (
    <div className="space-y-8">
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
        <MicrosoftOverview title="Microsoft Ms-900: Microsoft 365 Fundamentals" />
      </div>

      <div className="flex justify-center gap-6 mb-12 pt-10">
        <a
          href="#learning"
          className="px-6 py-3 text-lg font-semibold text-green-700 border-2 border-green-200 rounded-xl bg-green-50 hover:bg-green-200 transition"
        >
          Learning Resources
        </a>
        <a
          href="#pathway"
          className="px-6 py-3 text-lg font-semibold text-purple-700 border-2 border-purple-200 rounded-xl bg-purple-50 hover:bg-purple-200 transition"
        >
          Career Pathway
        </a>
      </div>
      ...
      >
        ...
        <Learn title="Microsoft Ms-900: Microsoft 365 Fundamentals" />
      </div>
      ...
      >
        ...
        <MyPathway title="Microsoft Ms-900: Microsoft 365 Fundamentals" />
      </div>
    </div>
  );
  ...
  const CombinedCertify = () => (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-yellow-50 to-amber-50 p-6 rounded-xl border border-yellow-100">
        ...
        <Practice course={"Microsoft"} subTopic={"MicrosoftMs900"}/>
      </div>
      <div className="bg-gradient-to-r from-purple-100 to-blue-50 p-6 rounded-xl border border-orange-100">
        ...
        <Certify title="Microsoft Ms-900: Microsoft 365 Fundamentals" />
      </div>
      ...
      <div className="bg-white shadow-md border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">›</span>
            <span className="text-blue-600 font-semibold">Microsoft Ms-900</span>
          </div>
        </div>
      </div>
