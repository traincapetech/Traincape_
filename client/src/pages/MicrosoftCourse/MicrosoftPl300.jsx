...
const MicrosoftPl300 = () => {
    const tabs = {
        Overview: <MicrosoftOverview title={"Microsoft Pl-300 Microsoft Power Bi Certification Training"} />,
        Certify: <Certify title={"Microsoft Pl-300 Microsoft Power Bi Certification Training" } />,
        Learn: <Learn title={"Microsoft Pl-300 Microsoft Power Bi Certification Training "} />,
        Practice : <Practice course={"Microsoft"} subTopic={"MicrosoftPl-300MicrosoftPowerBiCertificationTraining"}/>,
        'My Pathway': <MyPathway title={"Microsoft Pl-300 Microsoft Power Bi Certification Training"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
