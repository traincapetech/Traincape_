...
const MicrosoftPowerbi = () => {
    const tabs = {
        Overview: <MicrosoftOverview title={"Microsoft Power b i"} />,
        Certify: <Certify title={"Microsoft Power b i" } />,
        Learn: <Learn title={"Microsoft Power b i "} />,
        Practice : <Practice course={"Microsoft"} subTopic={"MicrosoftPowerbi"}/>,
        'My Pathway': <MyPathway title={"Microsoft Power b i"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
