  ...
  const CombinedCertify = () => (
    <div className="space-y-8">
      <div className="bg-gradient-to-r from-orange-50 to-red-50 p-6 rounded-xl border border-orange-100">
        ...
        <Certify title={"Microsoft Power BI"} />
      </div>
      <div className="bg-gradient-to-r from-yellow-50 to-amber-50 p-6 rounded-xl border border-yellow-100">
        ...
        <Practice course={"Microsoft"} subTopic={"MicrosoftPowerBI"} />
      </div>
    </div>
  );
  ...
  return (
    <>
      ...
      <div className="bg-white shadow-md border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">›</span>
            <span className="text-blue-600 font-semibold">Power BI</span>
          </div>
        </div>
      </div>
      ...
      <TabContainer
        ...
        subtitle="Microsoft Power BI Certification"
      />
    </>
  );
};
