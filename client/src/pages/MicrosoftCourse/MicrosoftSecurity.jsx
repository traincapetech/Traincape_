...
const MicrosoftSecurity = () => {
    const tabs = {
        Overview: <MicrosoftOverview title={"Microsoft Security, Compliance and Identity"} />,
        Certify: <Certify title={"Microsoft Security, Compliance and Identity" } />,
        Learn: <Learn title={"Microsoft Security, Compliance and Identity "} />,
        Practice : <Practice course={"Microsoft"} subTopic={"Microsoftsecurity,complianceandIdentity"}/>,
        'My Pathway': <MyPathway title={"Microsoft Security, Compliance and Identity"} />,
       // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
