...
const Computerforensics = () => {
    const tabs = {
        Overview: <Overview title={"PECB Certified Computer forensics"} />,
        Certify: <Certify title={"PECB Certified Computer forensics"} />,
        Learn: <Learn title={"PECB Certified Security"}/>,
        Practice : <Practice course={"PECB"} subTopic={"PECBComputerForensics"}/>,
        'My Pathway': <MyPathway title={"PECB Certified Computer forensics"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
