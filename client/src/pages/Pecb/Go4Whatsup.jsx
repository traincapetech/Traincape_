...
const Go4Whatsup = () => {
    const tabs = {
        Overview: <Overview title={"PECB Certified Security"} />,
        Certify: <Certify title={"PECB Certified Security"} />,
        Learn: <Learn title={"PECB Certified Security"}/>,
        Practice : <Practice course={"PECB"} subTopic={"Go4Whatsup"}/>,
        'My Pathway': <MyPathway title={"PECB Certified Security"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
