...
const ISO22301 = () => {
    const tabs = {
        Overview: <Overview title={"PECB ISO-22301"} />,
        Certify: <Certify title={"PECB ISO-22301"} />,
        Learn: <Learn title={"PECB ISO-22301"}/>,
        Practice : <Practice course={"PECB"} subTopic={"PECBISO22301"}/>,
        'My Pathway': <MyPathway title={"PECB ISO-22301"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
