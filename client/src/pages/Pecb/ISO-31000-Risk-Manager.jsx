...
const ISO31000RiskManager = () => {
    const tabs = {
        Overview: <Overview title={"PECB ISO-31000 Risk Manager"} />,
        Certify: <Certify title={"PECB ISO-31000 Risk Manager"} />,
        Learn: <Learn title={"PECB ISO-31000 Risk Manager"}/>,
        Practice : <Practice course={"PECB"} subTopic={"PECBISO31000RiskManager"}/>,
        'My Pathway': <MyPathway title={"PECB ISO-31000 Risk Manager"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
...
export default ISO31000RiskManager;