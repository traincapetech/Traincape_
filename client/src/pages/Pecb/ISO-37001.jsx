...
const ISO37001 = () => {
    const tabs = {
        Overview: <Overview title={"PECB ISO-37001"} />,
        Certify: <Certify title={"PECB ISO-37001"} />,
        Learn: <Learn title={"PECB ISO-37001"}/>,
        Practice : <Practice course={"PECB"} subTopic={"PECBISO37001"}/>,
        'My Pathway': <MyPathway title={"PECB ISO-37001"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
