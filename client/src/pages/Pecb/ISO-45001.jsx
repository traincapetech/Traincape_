...
const ISO45001 = () => {
    const tabs = {
        Overview: <Overview title={"PECB ISO-45001"} />,
        Certify: <Certify title={"PECB ISO-45001"} />,
        Learn: <Learn title={"PECB ISO-45001"}/>,
        Practice : <Practice course={"PECB"} subTopic={"PECBISO45001"}/>,
        'My Pathway': <MyPathway title={"PECB ISO-45001"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
