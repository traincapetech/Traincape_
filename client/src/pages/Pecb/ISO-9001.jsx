...
const ISO9001 = () => {
    const tabs = {
        Overview: <Overview title={"PECB ISO-9001"} />,
        Certify: <Certify title={"PECB ISO-9001"} />,
        Learn: <Learn title={"PECB ISO-9001"}/>,
        Practice : <Practice course={"PECB"} subTopic={"PECBISO9001"}/>,
        'My Pathway': <MyPathway title={"PECB ISO-9001"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
