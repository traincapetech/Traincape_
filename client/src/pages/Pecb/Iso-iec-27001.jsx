...
const Isoiec27001 = () => {
    const tabs = {
        Overview: <Overview title={"PECB ISOIEC-27001"} />,
        Certify: <Certify title={"PECB ISOIEC-27001"} />,
        Learn: <Learn title={"PECB ISOIEC-27001"}/>,
        Practice : <Practice course={"PECB"} subTopic={"PECBISOIEC27001"}/>,
        'My Pathway': <MyPathway title={"PECB ISOIEC-27001"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
