...
const Isoiec27005RiskManager = () => {
    const tabs = {
        Overview: <Overview title={"PECB ISOIEC-27005 Risk Manager"} />,
        Certify: <Certify title={"PECB ISOIEC-27005 Risk Manager"} />,
        Learn: <Learn title={"PECB ISOIEC-27005 Risk Manager"}/>,
        Practice : <Practice course={"PECB"} subTopic={"PECBISOIEC27005RiskManager"}/>,
        'My Pathway': <MyPathway title={"PECB ISOIEC-27005 Risk Manager"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
...
export default Isoiec27005RiskManager;