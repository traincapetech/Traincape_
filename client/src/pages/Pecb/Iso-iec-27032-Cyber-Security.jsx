...
const Isoiec270032CyberSecurity = () => {
    const tabs = {
        Overview: <Overview title={"PECB ISOIEC-27032 Cyber Security"} />,
        Certify: <Certify title={"PECB ISOIEC-27032 Cyber Security"} />,
        Learn: <Learn title={"PECB ISOIEC-27032 Cyber Security"}/>,
        Practice : <Practice course={"PECB"} subTopic={"PECBISOIEC27032CyberSecurity"}/>,
        'My Pathway': <MyPathway title={"PECB ISOIEC-27032 Cyber Security"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
...
export default Isoiec270032CyberSecurity;