      ...
      <div className="grid sm:grid-flow-row grid-cols-1 lg:flex">
        ...
        >
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-center text-sm mt-2">PECB Certified ISO 27001 Foundation</p>
          </div>
...
const PecbCertifiedIso27001Foundation = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);

  const courseName = "PECB Certified ISO 27001 Foundation";
  ...
  const CombinedCertify = () => (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-yellow-50 to-amber-50 p-6 rounded-xl border border-yellow-100">
        ...
        <Practice course={"PECB"} subTopic={"PecbCertifiedIso27001Foundation"}/>
      </div>
    </div>
  );
      ...
      <div className="bg-white shadow-lg border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">›</span>
            <span className="text-blue-600 font-semibold">ISO 27001 Foundation</span>
          </div>
        </div>
      </div>
...
export default PecbCertifiedIso27001Foundation;