...
const PecbCertifiedIso27001Foundation = () => {
    const tabs = {
        Overview: <Overview title={"PECB ISO-27001 Foundation"} />,
        Certify: <Certify title={"PECB ISO-27001 Foundation"} />,
        Learn: <Learn title={"PECB ISO-27001 Foundation"}/>,
        Practice : <Practice course={"PECB"} subTopic={"PECBCertifiedISO27001Foundation"}/>,
        'My Pathway': <MyPathway title={"PECB ISO-27001 Foundation"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
