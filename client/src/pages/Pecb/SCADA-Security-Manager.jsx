...
const SCADASecurityManager = () => {
    const tabs = {
        Overview: <Overview title={"SCADA Security Manager"} />,
        Certify: <Certify title={"SCADA Security Manager"} />,
        Learn: <Learn title={"SCADA Security Manager"}/>,
        Practice : <Practice course={"PECB"} subTopic={"SCADASecurityManager"}/>,
        'My Pathway': <MyPathway title={"SCADA Security Manager"} />,
        // Resources:< Resources/>,
        Contact: <ContactUs />,
      };
