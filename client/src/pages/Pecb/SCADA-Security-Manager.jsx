        ...
        >
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-center bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
              PECB SCADA Security Manager
            </h2>
            <p className="text-gray-400 text-center text-sm mt-2">PECB Certified Lead SCADA Security Manager</p>
          </div>
...
const SCADASecurityManager = () => {
  ...
  const courseName = "PECB Certified Lead SCADA Security Manager";
  ...
  const CombinedCertify = () => (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-yellow-50 to-amber-50 p-6 rounded-xl border border-yellow-100">
        ...
        <Practice course={"PECB"} subTopic={"SCADASecurityManager"}/>
      </div>
      ...
      <div className="bg-white shadow-lg border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-400">›</span>
            <span className="text-blue-600 font-semibold">SCADA Security Manager</span>
          </div>
        </div>
      </div>
