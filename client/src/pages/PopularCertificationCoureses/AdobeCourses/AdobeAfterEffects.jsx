        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 text-white mb-8 md:mb-0">
            ...
            <p className="text-xl md:text-2xl mb-6">
              Learn to create stunning motion graphics and visual effects.
            </p>
          ...
          <div className="md:w-1/3">
            <img
              src={require('../../../assets/adobe6.webp')}
          ...
          <div className="lg:w-2/3">
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-700 mb-4">
                The Adobe Certified Professional – After Effects certification proves your
                ability to design and create cinematic visual effects, motion graphics,
                and animation. This course is ideal for aspiring video editors, content
                creators, and digital artists.
              </p>
              <p className="text-gray-700 mb-4">
                Learn the essential skills required to pass the ACP exam and build a
                portfolio of creative video projects.
              </p>
            </div>
            ...
            <div className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  "After Effects interface and workflow",
                  "Working with keyframes and animation",
                  "Applying visual effects and presets",
                  "Using 3D layers and cameras",
                  "Motion tracking and stabilization",
                  "Green screen and chroma keying",
                  "Text and title animation",
                  "Exporting for web, broadcast, and mobile",
                ].map((item, i) => (
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-700 mb-4">
                After Effects professionals are in demand in the media and
                entertainment industry. Certification can open doors to video
                production studios, advertising agencies, and freelance motion
                design work.
              </p>
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <ul className="space-y-2">
                  <li className="flex justify-between">
                    <span className="text-gray-700">Motion Graphics Designer</span>
                    <span className="font-medium">₹4–9 LPA</span>
                  </li>
                  <li className="flex justify-between">
                  ...
                  <li className="flex justify-between">
                    <span className="text-gray-700">Visual Effects Artist</span>
                    <span className="font-medium">₹5–10 LPA</span>
                  </li>
                  <li className="flex justify-between">
                    <span className="text-gray-700">Freelance Animator</span>
                    <span className="font-medium">₹2–8 LPA</span>
                  </li>
                </ul>
              </div>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li>• Output and rendering techniques</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div className="mb-12">
              ...
              {[
                {
                  q: "Do I need to know animation before starting?",
                  a: "No, this course starts from basics and teaches all animation fundamentals in After Effects.",
                },
                {
                  q: "Can I use this for freelance projects?",
                  a: "Absolutely. The skills and certification are valuable for freelance and client-based work.",
                },
                {
                  q: "Is this certification valid internationally?",
                  a: "Yes, it is recognized globally by media and creative professionals.",
                },
              ].map(({ q, a }, i) => (
          ...
          <div className="lg:w-1/3">
            <div className="bg-white rounded-xl shadow-lg p-6 sticky top-8">
              ...
              <div className="mt-6">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li>✔ Full After Effects training</li>
                  <li>✔ Downloadable resources</li>
                  <li>✔ Motion design projects</li>
