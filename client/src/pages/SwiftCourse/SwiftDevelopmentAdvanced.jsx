            ...
            <div>
              ...
              <div className="mb-10">
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4 pl-4">
                  <li><strong>Senior iOS Developer</strong> (₹10-18 LPA)</li>
                  <li><strong>iOS Team Lead</strong> (₹15-25 LPA)</li>
                  <li><strong>Mobile Architect</strong> (₹18-30 LPA)</li>
                  <li><strong>Swift Framework Developer</strong> (₹12-20 LPA)</li>
                  <li><strong>iOS Gaming Developer</strong> (₹8-15 LPA)</li>
                </ul>
              </div>
