...
const SwiftDevelopmentBasics = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      id: "swiftbasics",
      title: "Swift Development Basics",
      price: 2499,
      image: "https://upload.wikimedia.org/wikipedia/commons/9/9d/Swift_logo.svg", // Replace with actual URL
      quantity: 1,
    };
    addToCart(product);
  ...
  return (
    <>
      ...
      <div className="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-white w-full h-auto md:h-[24rem] pt-10 px-4 md:px-10 text-left overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-sm md:text-base text-gray-600 mt-3 max-w-xl text-center md:text-left xl:pl-20">
            Learn iOS and macOS app development with Swift, Apple's powerful and intuitive programming language.
          </p>
        </div>
        ...
        <div className="mt-6 md:absolute md:top-10 md:right-10 w-full md:w-80 h-auto md:h-auto flex flex-col items-center md:items-start bg-white shadow-xl p-6 rounded-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 z-10">
          ...
          <div className="bg-gradient-to-r from-blue-500 to-indigo-600 w-full py-2 px-4 rounded-lg mb-4">
            <h1 className="text-lg md:text-xl font-bold text-white text-center">Course</h1>
          </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 md:bottom-10 md:left-auto md:right-10 lg:right-[1rem] lg:top-[25rem] xl:right-[15rem] xl:top-[30rem] max-w-full md:max-w-xs bg-white p-6 shadow-xl rounded-xl border border-gray-100 z-40 backdrop-blur-sm bg-white/95">
        ...
        {/* Limited time offer */}
        <p className="text-xs text-gray-500 mb-3">Limited time launch offer</p>
            ...
            <div>
              <div className="mb-8">
                ...
                <p className="text-gray-700 mb-4">
                  Swift Development Basics is your gateway to building iOS and macOS applications. In this comprehensive course, you'll learn the fundamentals of Swift programming, Apple's powerful and intuitive language designed specifically for building apps across all Apple platforms.
                </p>
                <p className="text-gray-700 mb-4">
                  Whether you're a complete beginner or have some programming experience, this course will guide you through Swift syntax, iOS app architecture, and UI development with step-by-step instructions and hands-on projects. By the end, you'll have built several real-world applications and gained a solid foundation in Swift development.
                </p>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-blue-700">
                        <strong>Sales Note:</strong> iOS developers are in high demand, with average salaries of ₹6-12 LPA for entry-level positions. The App Store market continues to grow, offering significant opportunities for Swift developers.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-white rounded-lg border p-5 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <p className="text-gray-600">Mac computer, no prior coding experience needed</p>
                </div>
              </div>
                  ...
                  <div className="bg-white rounded-lg border p-4 shadow-sm">
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        ...
                        <span>Swift programming fundamentals and syntax</span>
                      </li>
                      <li className="flex items-start">
                        <svg className="w-5 h-5 text-green-500 mr-2 mt-1" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                        </svg>
                        <span>iOS app architecture and development patterns</span>
                      </li>
                      <li className="flex items-start">
                        <svg className="w-5 h-5 text-green-500 mr-2 mt-1" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                        </svg>
                        <span>Building UI with UIKit fundamentals</span>
                      </li>
                    </ul>
                  </div>
                  <div className="bg-white rounded-lg border p-4 shadow-sm">
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        ...
                        <span>Working with networking and APIs</span>
                      </li>
                      <li className="flex items-start">
                        <svg className="w-5 h-5 text-green-500 mr-2 mt-1" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                        </svg>
                        <span>Data persistence with Core Data</span>
                      </li>
                      <li className="flex items-start">
                        <svg className="w-5 h-5 text-green-500 mr-2 mt-1" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                        </svg>
                        <span>Publishing your app to the App Store</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-700 mb-4">
                  With Swift development skills, you'll be qualified for roles such as:
                </p>
                <div className="grid md:grid-cols-3 gap-4 mt-4">
                  ...
                  <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
                    <h3 className="font-medium text-gray-900">App Entrepreneur</h3>
                    <p className="text-sm text-gray-600 mt-1">Build and publish your own apps</p>
                  </div>
                </div>
              </div>
              ...
              {/* Project Showcase */}
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Projects You'll Build</h2>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-white rounded-lg border p-5 shadow-sm">
                    <h3 className="font-semibold text-lg text-indigo-700 mb-3">Weather App</h3>
                    <p className="text-gray-700 mb-3">Build a beautiful weather application that fetches real-time data from APIs and displays forecasts with an intuitive UI.</p>
                    <div className="text-sm text-gray-500">
                      <span className="inline-block bg-blue-100 text-blue-800 rounded-full px-3 py-1 text-xs font-semibold mr-2 mb-2">UIKit</span>
                      <span className="inline-block bg-blue-100 text-blue-800 rounded-full px-3 py-1 text-xs font-semibold mr-2 mb-2">Networking</span>
                      <span className="inline-block bg-blue-100 text-blue-800 rounded-full px-3 py-1 text-xs font-semibold mr-2 mb-2">JSON</span>
                    </div>
                  </div>
                  
                  <div className="bg-white rounded-lg border p-5 shadow-sm">
                    <h3 className="font-semibold text-lg text-indigo-700 mb-3">To-Do List App</h3>
                    <p className="text-gray-700 mb-3">Create a productivity app that helps users manage tasks, with data persistence, notifications, and a clean interface.</p>
                    <div className="text-sm text-gray-500">
                      <span className="inline-block bg-blue-100 text-blue-800 rounded-full px-3 py-1 text-xs font-semibold mr-2 mb-2">Core Data</span>
                      <span className="inline-block bg-blue-100 text-blue-800 rounded-full px-3 py-1 text-xs font-semibold mr-2 mb-2">Notifications</span>
                      <span className="inline-block bg-blue-100 text-blue-800 rounded-full px-3 py-1 text-xs font-semibold mr-2 mb-2">Table Views</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-3">
                    ...
                    {selectedQuestion === 0 && (
                      <div className="p-4 bg-white border-t border-gray-200">
                        <p className="text-gray-700">
                          Yes, you'll need a Mac computer to run Xcode, Apple's development environment for iOS and macOS applications. Xcode is only available for macOS and is essential for Swift development.
                        </p>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    {selectedQuestion === 1 && (
                      <div className="p-4 bg-white border-t border-gray-200">
                        <p className="text-gray-700">
                          No prior programming experience is required. This course is designed for beginners and starts with the fundamentals of Swift programming. If you have some programming knowledge, you'll progress more quickly, but it's not necessary to succeed in this course.
                        </p>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    >
                      <p className="font-semibold text-gray-900">
                        Will I be able to publish my own app after this course?
                      </p>
                    ...
                    {selectedQuestion === 2 && (
                      <div className="p-4 bg-white border-t border-gray-200">
                        <p className="text-gray-700">
                          Yes! The course includes a module on app publishing that walks you through the process of preparing your app for the App Store, creating screenshots, writing descriptions, and submitting for review. You'll need an Apple Developer account ($99/year) to publish your app.
                        </p>
                      </div>
                    )}
                  </div>
...
export default SwiftDevelopmentBasics; 